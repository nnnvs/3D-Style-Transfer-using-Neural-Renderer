...
DIR=./data
python ./../main/run.py -im ${DIR}/meshes/teapot.obj -is ${DIR}/styles/coupland1.jpg -o ${DIR}/results/teapot_coupland1-test.gif -rd ${DIR}/results
python ./../main/run.py -im ${DIR}/meshes/bunny.obj -is ${DIR}/styles/gogh2.jpg -o ${DIR}/results/bunny_gogh2-test.gif -rd ${DIR}/results
